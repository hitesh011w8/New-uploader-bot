...
SUDO_USERS = [6344648593,8934239673,8500762588]

# ✅ Multiple AUTH CHANNELS allowed
AUTH_CHANNELS = [-1002632338940,-1002663510614]  # Add more channel IDs here
...
async def edit_txt(client, message: Message):
    ...
    try:
        await message.reply_document(
            ...
            caption="📥**𝗘𝗱𝗶𝘁𝗲𝗱 𝗕𝘆 ➤ 𓆩RAO𓆪𓆩SAHAB𓆪**"
        )
    except Exception as e:
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/radhe` - Download and upload files (sudo)🎬\n\n"
...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[𓆩RAO𓆪𓆩SAHAB𓆪](https://t.me/RAO_SAHAB_JI_BOT)"
    if raw_text3 == '1':
        CR = '[𓆩RAO𓆪𓆩SAHAB𓆪](https://t.me/RAO_SAHAB_JI_BOT)'
    elif raw_text3:
        try:
    ...
    await editable.edit("𝗡𝗼𝘄 𝗦𝗲𝗻𝗱 𝗧𝗵𝗲 𝗧𝗵𝘂𝗺𝗯 𝗨𝗿𝗹 𝗘𝗴 » https://files.catbox.moe/t9yho3.jpg\n\n𝗢𝗿 𝗜𝗳 𝗗𝗼𝗻'𝘁 𝗪𝗮𝗻𝘁 𝗧𝗵𝘂𝗺𝗯𝗻𝗮𝗶𝗹 𝗦𝗲𝗻𝗱 = 𝗻𝗼")
    ...
    await m.reply_text(f"`✨𝗕𝗔𝗧𝗖𝗛 𝗦𝗨𝗠𝗠𝗔𝗥𝗬✨\n\n"
                       ...
                       f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
                       f"✅𝗦𝗧𝗔𝗧𝗨𝗦 » 𝗖𝗢𝗠𝗣𝗟𝗘𝗧𝗘𝗗`")
    await m.reply_text(f"<pre><code>📥𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗲𝗱 𝗕𝘆 ➤『{𓆩RAO𓆪𓆩SAHAB𓆪}』</code></pre>")          
